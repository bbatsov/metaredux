...
started to update its dependencies and CI setup.
...
to you as part of the upcoming **CIDER 2.1**. Calva and other nREPL-based tools
that depend on clj-suitable will pick it up on their own schedule.
