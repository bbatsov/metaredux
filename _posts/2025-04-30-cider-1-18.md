...
- The middleware that powers dynamic font-locking was made tremendously faster and more memory efficient on both Clojure and Emacs sides of CIDER. Again, this effect would be more pronounced in large codebases.
