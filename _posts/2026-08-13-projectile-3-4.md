...
naming it: a lot of what I work on isn't one directory. [CIDER][cider] is really CIDER plus
[cider-nrepl][cider-nrepl] plus [orchard][orchard] plus [clj-refactor][clj-refactor] plus a
handful of others. [RuboCop][rubocop] is RuboCop plus [rubocop-ast][rubocop-ast] plus
[rubocop-rails][rubocop-rails] and the other extension gems plus [the style
guide][ruby-style-guide]. I've been maintaining families of repositories for the better
part of a decade.
...
directory names would ever have related them. [haystack][haystack] parses stack traces,
[port][port] is a printer registry, [sayid][sayid] is a tracing debugger. Nothing in those
names says "CIDER".

What they do have in common is an org: they all live under
[clojure-emacs][clojure-emacs] on GitHub. That's not incidental, it's how the project is
...
the [rubocop][rubocop-org] org, and for [nrepl][nrepl-org]. Once I saw that, keying on the
...
Switching is only the obvious thing to do with this. Now that Projectile can tell which
...
[haystack]: https://github.com/clojure-emacs/haystack
...
[rubocop-org]: https://github.com/rubocop
[nrepl-org]: https://github.com/nrepl
