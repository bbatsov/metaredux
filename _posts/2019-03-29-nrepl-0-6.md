...
* Big results start appearing much faster than before.
* You can interrupt the printing of a big result.
* You can set a hard limit for the size of a result.

More information about the new middleware is available in the [user
manua](https://nrepl.org/nrepl/0.6.0/design/middleware.html#_pretty_printing).
