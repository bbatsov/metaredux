...
The above is from a [2015 conversation](https://groups.google.com/forum/?pli=1#!msg/clojure-dev/Dl3Stw5iRVA/D_Kcb-naOx4J) around the introduction of Clojure's socket REPL server and what problems does it solve. I've seen this conversation cited many times over the years to support the thesis that nREPL is problematic in one regard or another.
