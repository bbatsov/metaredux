...
0.4](https://github.com/copilot-emacs/copilot.el/releases/tag/v0.4.0) is out!

But that's just the start of it. This is the most important release
for me since I assumed the project's leadership and I hope this
article will manage to make you agree with my reasoning.
...
This might sound like a dry and boring internal change, but it's actually a big
...
[buttercup](https://github.com/jorgenschaefer/emacs-buttercup). We went from
...
The README got a (almost) complete rewrite -- it now covers installation for
...
This might sound like a lot of effort for not much user-visible payoff, but when
I started hacking on the project:
